...
export function SearchBar({ isOpen, onClose }: SearchBarProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <div className="max-h-[85vh] w-full max-w-3xl overflow-hidden rounded-2xl bg-[#fffbfb] shadow-2xl">
        ...
        <div className="border-b p-6">
          ...
          >
            <input
              ...
              className="w-full rounded-xl border-2 border-primary bg-white px-4 py-4 pr-14 text-lg text-slate-700 outline-none"
              autoFocus
              value={keyword}
            ...
            <button
              type="submit"
              className="absolute right-2 top-2 rounded-lg bg-red-50 p-3 text-primary hover:bg-red-100"
            >
